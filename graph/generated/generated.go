...
type MutationResolver interface {
	...
	UpdateProduct(ctx context.Context, id *int, input *model.NewProduct) (*model.Product, error)
	DeleteProduct(ctx context.Context, id *int) ([]*model.Product, error)
}
...
func (ec *executionContext) field_Mutation_createProduct_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalONewProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐNewProduct(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateProduct_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg1, err = ec.unmarshalONewProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐNewProduct(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateProduct(rctx, args["id"].(*int), args["input"].(*model.NewProduct))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_deleteProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2githubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v model.Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚕᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalONewProduct2githubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐNewProduct(ctx context.Context, v interface{}) (model.NewProduct, error) {
	return ec.unmarshalInputNewProduct(ctx, v)
}

func (ec *executionContext) unmarshalONewProduct2ᚖgithubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐNewProduct(ctx context.Context, v interface{}) (*model.NewProduct, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalONewProduct2githubᚗcomᚋAkshayterminᚋgqlbeegoᚋgraphᚋmodelᚐNewProduct(ctx, v)
	return &res, err
}
